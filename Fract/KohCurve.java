...
import javax.swing.*;
public class KohCurve extends javax.swing.JComponent {
    ...
    public static void main(String[] args) {
        KohCurve curve = new KohCurve();
        curve.setPreferredSize(new Dimension(width,height));
        curve.creatAndShowGUI();
    }
    ...
    private void creatAndShowGUI(){
        ...
        list.addElement("Глубина "+ depth +" | время рисовки = " + elapsedTime );
